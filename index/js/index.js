$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*Hi,我的名字叫刘巧，是一位2021年毕业的应届毕业生，我致力于修炼Web前端开发！</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要工作是主要职责是利用HTML/CSS/JavaScript/DOM等各种Web技术进行产品的界面开发。制作标准优化的代码，并增加交互动态功能，开发JavaScript模块，同时结合后台开发技术模拟整体效果，进行丰富互联网的Web开发，致力于通过技术改善用户体验。</div>",2000);
	...
	w.load("<div class='writecode'>Web前端开发工程师(2021届本科应届生)</div>");
	...
	w.load("<li class='writecode'>熟练各种Web前端开发技术H5,CSS3,jQuery,Vue.js框架,Web响应式开发,bootstarp框架设计</li>");
	w.load("<li class='writecode'>熟练PHP后端开发语言，并独立运用PHP开发过一个音乐分享平台，了解Node.js后端开发技术,了解express框架</li>");
	w.load("<li class='writecode'>熟练git等常用版本管理工具</li>");
