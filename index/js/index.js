$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*Hi,我的名字叫刘巧，是一位2021年毕业的应届毕业生，曾经致力于修炼Web前端开发，现在想做一位优秀的产品经理！</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要职责是负责并保证高质量的软件产品按时完成和发布的专职管理人员。</div>",2000);
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*让我们来让它的可读性更好一点吧</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	...
	w.load("<p><div class='writecode'>刘巧</div>");
	w.load("<p><div class='writecode'>电子科技大学成都学院-软件工程</div>");
	w.load("<div class='writecode'>IT产品经理实习生(2021届本科应届生)</div>");
	w.load("<div class='writecode'>个人订阅号：往生路</div></p>");
	w.load("<div class='writecode'>中共党员</div></p>");
	...
	w.load("<li class='writecode'>coding:<a href='https://dev.tencent.com/u/morly7' target='_blank'>https://dev.tencent.com/u/morly7</a></li>");
	w.load("<li class='writecode'>pmdaniu:<a href='https://www.pmdaniu.com/p/morly' target='_blank'>https://www.pmdaniu.com/p/morly</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>精通 HTML/CSS/JavaScript开发技术，有过1年科技公司web前端开发经验</li>");
	w.load("<li class='writecode'>熟练各种原型设计工具（Axure、墨刀、Mockplus、小piu等等）</li>");
	w.load("<li class='writecode'>熟练XMind、Visio以及其余在线的流程图绘制工具，有很好的流程图绘制逻辑</li>");
	w.load("<li class='writecode'>熟练PHP后端开发语言，并使用原生PHP开发过一个音乐分享平台</li>");
	w.load("<li class='writecode'>熟练Git、SVN等常用版本管理工具</li>");
	w.load("<li class='writecode'>熟练SEO搜索引擎优化，并对其中的技巧做过深入的研究</li>");
	w.load("<li class='writecode'>熟练Mysql数据库，并在之前的开发项目中都使用了Mysql作为数据库进行数据存储</li>");
	w.load("<li class='writecode'>了解服务器部署和管理，及常见问题的处理，独立配置过项目在阿里平台上</li>");
	w.load("<li class='writecode'>有过项目管理经验，合作交流效率高，对前端技术迭代的学习能力强</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>项目</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='https://github.com/liuqiao666/vue-mybolg' target='_blank'>vue-mybolg--vue2.0+vue-router+mongoDB+koa2+vuex+响应式布局</a></li>");
	w.load("<li class='writecode'><a href='https://github.com/liuqiao666/travel' target='_blank'>SEO课程_旅游网站</a></li>");
	w.load("<li class='writecode'><a href='https://github.com/liuqiao666/php-cms' target='_blank'>基于php的内容管理系统</a></li>");
	w.load("<li class='writecode'><a href='https://github.com/liuqiao666/sports' target='_blank'>体育赛事管理系统</a></li>");
	w.load("<li class='writecode'><a href='https://github.com/liuqiao666/node-http-tcp' target='_blank'>node.js搭建http，tcp服务器和客户端，并实现相互通信</a></li>");
	w.load("<li class='writecode'><a href='https://github.com/liuqiao666/music' target='_blank'>基于php的音乐推荐平台</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>奖项</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>2016年计算机系演讲比赛二等奖 、2016年全国大学生英语竞赛D组二等奖 、2016年全国大学生“外社研杯”英语作文初赛一等奖 </li>");
	w.load("<li class='writecode'>2016年全国大学生信息素养大赛BAP认证 、2017年学院一等奖学金 、2017年国家励志奖学金 </li>");
	w.load("<li class='writecode'>2018年学院一等奖学金 、2018年国家励志奖学金</li>");
	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*左面的简历看起来不是太令人满意，让我们先给它来点动态渲染</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='comment writecode'>&nbsp;*微信:qq604588</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:13208166720</div>");
